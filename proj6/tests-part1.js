tests(
  ...
  {
    name: 'iterative',
    code: 'var subst = new Subst().bind("X",new Var("Y")).bind("Y", new Clause("z"));\n' +
          'new Var("X").rewrite(subst);',
    expected: new Clause("z")
  },
  {
    name: 'iterative2',
    code: 'var subst = new Subst().bind("X",new Clause("baz", [new Var("Y"), new Var("Z"), new Clause("test", [new Var("YZ")])])).bind("Y", new Clause("z")).bind("Z", new Var("z2")).bind("YZ", new Var("z3"));\n' +
          'new Var("X").rewrite(subst);',
    expected: new Clause("baz", [new Clause("z"), new Var("z2"), new Clause("test", [new Var("z3")])])
  },
  {
    name: 'iterative3',
    code: 'var subst = new Subst().bind("X",new Var("Y")).bind("Y", new Var("Z")).bind("Z", new Clause("z2"));\n' +
          'new Var("X").rewrite(subst);',
    expected: new Clause("z2")
  },
  {
    name: 'iterative4',
    code: 'var subst = new Subst().bind("X",new Clause("baz", [new Var("Y")])).bind("Y", new Clause("z"));\n' +
          'new Var("X").rewrite(subst);',
    expected: new Clause("baz", [new Clause("z")])
  }
